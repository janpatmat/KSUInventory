...
public class EditTransaction extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel6.setText("EDIT TRANSACTION MENU");

        ET_deleteBtn.setText("Delete");
        ET_deleteBtn.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ET_deleteBtnActionPerformed(evt);
            }
        });
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(ET_DateChooser, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(ET_QuantTF, javax.swing.GroupLayout.DEFAULT_SIZE, 124, Short.MAX_VALUE))
                        .addGap(43, 43, 43)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(jLabel7)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(ET_bsCB, javax.swing.GroupLayout.PREFERRED_SIZE, 118, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(ET_editBTN, javax.swing.GroupLayout.PREFERRED_SIZE, 88, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void ET_editBTNActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ET_editBTNActionPerformed
        ...
        try{
            if (ET_TransactionTable.getSelectedRowCount() == 1){
                ...
                JOptionPane.showMessageDialog(this,"Please Select only 1 Row", "Error", JOptionPane.ERROR_MESSAGE);
            }
        }catch(Exception ex){
...
//        }
    ...
    private void ET_deleteBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ET_deleteBtnActionPerformed
        if (ET_TransactionTable.getSelectedRowCount() > 0){

            for (int index: ET_TransactionTable.getSelectedRows()){
                int trudex = Integer.parseInt(transactionArr.get(index)[0]);

                try{
                    st = KsuFinal.con.prepareStatement("DELETE FROM producttrans WHERE TransactionNo = " + trudex);
                    st.executeUpdate();
                }
                catch(Exception e){
                    System.out.println(e);
            ...
            updateTable();
            JOptionPane.showMessageDialog(this,"Successfully deleted the Transaction");

        }else{
            JOptionPane.showMessageDialog(this,"Please select a row", "Error", JOptionPane.ERROR_MESSAGE);
        }
    }//GEN-LAST:event_ET_deleteBtnActionPerformed
    ...
    private javax.swing.JButton ET_deleteBtn;
