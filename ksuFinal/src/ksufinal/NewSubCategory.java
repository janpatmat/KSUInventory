 ...
 * @author Ricky
 */
public class NewSubCategory extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel6.setText("NEW SUB CATEGORY MENU");
    ...
    private void saveBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveBtnActionPerformed
        if(categoryNameTF.getText().length() == 0){
            ...
            try{
                ResultSet rs = KsuFinal.con.createStatement().executeQuery("SELECT * FROM subcategorytable WHERE subCategoryName = '" + categoryNameTF.getText() + "'");
                if (rs.next()){
                    JOptionPane.showMessageDialog(this,"Sub-Category Name already exist", "Error", JOptionPane.ERROR_MESSAGE);
                }else{
                    st = KsuFinal.con.prepareStatement("INSERT INTO subcategorytable (subCategoryName) VALUES(?)");

                    st.setString(1, categoryNameTF.getText());

                    st.executeUpdate();
                    categoryNameTF.setText("");
                    JOptionPane.showMessageDialog(this,"Successfully added the Sub-Category");
                }
            }
            catch(Exception e){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NewSubCategory.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NewSubCategory().setVisible(true);
            }
        });
    }
